...
public class TieredRuleTests
{
    ...
    {
        var sales = new List<SaleRecord> { TestData.Sale(1, 20_000m, "ALC") };
    ...
    public void Hedef_asilinca_oran_tum_ciroya_uygulanir()
    {
        ...
        {
            TestData.Sale(1, 30_000m, "ALC", day: 3),
            TestData.Sale(2, 10_000m, "ALC", day: 9)
        };
    ...
    {
        var sales = new List<SaleRecord> { TestData.Sale(1, 60_000m, "ALC") };
    ...
    {
        var sales = new List<SaleRecord> { TestData.Sale(1, 70_000m, "ALC") };

        var result = TestData.Calculator().Calculate(
            TestData.Employee("F&B"), sales,
    ...
    {
        var sales = new List<SaleRecord> { TestData.Sale(1, 45_000m, "ALC") };
